...
// Log tất cả các request để debug
...
app.get('/api/audio/:videoId/list', videoController.listAudioFiles);
app.get('/audio/:videoId/:timePoint.mp3', videoController.getAudioSegment);
